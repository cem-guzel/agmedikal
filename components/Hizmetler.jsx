...
const hizmetler = [
  {
    number: '01',
    title: 'Yetkili Satış',
    desc: 'Omron, Erka, Mediven ve daha fazlası için yetkili satış noktası. Orijinal ürün, resmi garanti.',
    detail: 'Stokta 500+ ürün',
  },
  {
    number: '02',
    title: 'Teknik Servis',
    desc: '20 yıllık tecrübeli ekibimizle biyomedikal cihazlarınızın bakım, onarım ve kalibrasyonu.',
    detail: '20 yıl deneyim',
  },
  {
    number: '03',
    title: 'Hızlı Teslimat',
    desc: 'Hatay ve çevre illerinde geniş teslimat ağımızla ürünleriniz kapınızda.',
    detail: 'Hatay geneli',
  },
  {
    number: '04',
    title: 'Uzman Danışmanlık',
    desc: 'Hangi ürünün size uygun olduğunu bilmiyorsanız uzman ekibimiz doğru çözümü bulur.',
    detail: 'Ücretsiz danışma',
  },
]
...
export default function Hizmetler() {
  ...
  useEffect(() => {
    ...
    // Satır animasyonları (autoAlpha ile düzeltildi)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7 relative order-2 lg:order-1 mt-12 lg:mt-0">
            ...
            {hizmetler.map((h, i) => (
              <div
                key={i}
                className="hizmet-row invisible group pl-8 md:pl-16 py-12 border-b border-slate-100 last:border-b-0 flex flex-col sm:flex-row sm:items-center gap-6 cursor-default hover:bg-slate-50/30 transition-all duration-500"
              >
                {/* Numara (Daha klas, tırnaklı font ve büyük boyut) */}
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-3">
                    <h3 className="text-slate-800 font-bold text-2xl group-hover:text-teal-600 transition-colors duration-300">
                      {h.title}
                    </h3>
          ...
          {/* SAĞ TARAF: Başlık ve CTA (5 Kolon) - Ekranda Sabit Kalır */}
          <div className="hizmet-header invisible lg:col-span-5 lg:sticky lg:top-40 order-1 lg:order-2 flex flex-col">
            ...
            <h2 className="text-slate-900 font-black leading-[1.1] tracking-tight text-4xl md:text-5xl lg:text-6xl mb-8">
              Size Nasıl<br />
              <span className="text-slate-300">Yardımcı</span><br />
              Olabiliriz?
            </h2>
            ...
            <div className="flex items-center gap-8">
              <Link
                href="/iletisim"
                className="group relative inline-flex items-center gap-4 text-slate-800 hover:text-teal-600 font-semibold text-sm tracking-widest uppercase transition-colors duration-300"
              >
