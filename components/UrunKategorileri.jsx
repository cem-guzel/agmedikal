        ...
        <div className="urun-header mb-16 invisible">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <h2 className="text-slate-900 font-black leading-[1.1] tracking-tight text-4xl md:text-5xl lg:text-6xl">
              Geniş Ürün<br /><span className="text-slate-400">Yelpazemiz</span>
            </h2>
            <Link href="/urunler" className="group inline-flex items-center gap-4 text-slate-500 hover:text-teal-600 text-sm font-bold tracking-widest uppercase transition-all duration-300 self-end">
